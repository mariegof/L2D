# Uniform Reward Sweep

## Experiment Details
- **Sweep ID:** i1sonpha
- **Timestamp:** 20250328_120336
- **Type:** Reward
- **Weight Type:** uniform
- **Total Runs:** 5
...
## Results Location
- **WandB URL:** https://wandb.ai/jssp-uniform-sum/sweeps/i1sonpha
- **Analysis Directory:** results/uniform_weights/reward_sweeps/20250328_120336/analysis
...
```
python scripts/concurrent_sweep_runner.py --config configs/sweep_config.yaml --sweep_type reward --weight_type uniform
```
