...
def parse_args():
    parser = argparse.ArgumentParser(description='Run WandB sweep for environment parameters')
    parser.add_argument('--config', type=str, default='configs/environment_sweeps.yaml',
