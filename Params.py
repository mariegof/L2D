...
parser.add_argument('--rewardscale', type=float, default=0.5, help='Reward scale for positive rewards')
...
parser.add_argument('--input_dim', type=int, default=7, help='number of dimension of raw node features')
...
parser.add_argument('--decay_step_size', type=int, default=10, help='decay_step_size')
parser.add_argument('--decay_ratio', type=float, default=0.25, help='decay_ratio, e.g. 0.9, 0.95')
