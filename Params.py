...
parser.add_argument('--rewardscale', type=float, default=0.3, help='Reward scale for positive rewards')
...
parser.add_argument('--weight_low', type=int, default=1, help='LB of weight')
parser.add_argument('--weight_high', type=int, default=10, help='UB of weight')
...
parser.add_argument('--hidden_dim', type=int, default=256, help='hidden dim of MLP in fea extract GNN')
...
parser.add_argument('--hidden_dim_critic', type=int, default=64, help='hidden dim of MLP in critic')
# args for PPO
parser.add_argument('--num_envs', type=int, default=8, help='No. of envs for training')
parser.add_argument('--max_updates', type=int, default=10000, help='No. of episodes of each env for training')
parser.add_argument('--lr', type=float, default=7e-4, help='lr')
...
parser.add_argument('--decay_ratio', type=float, default=0.95, help='decay_ratio, e.g. 0.9, 0.95')
...
parser.add_argument('--entloss_coef', type=float, default=0.02, help='entropy loss coefficient')
...
parser.add_argument('--reward_strategy', type=str, default='critical_path', 
